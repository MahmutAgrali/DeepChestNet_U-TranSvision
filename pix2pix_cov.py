# -*- coding: utf-8 -*-
"""
Created on Mon Aug 29 10:35:58 2022
"""
...
def define_discriminator(image_shape):
	"""
    @ This method provides to discriminator model
    @ params : 
...
def define_encoder_block(layer_in, n_filters, batchnorm=True):
	"""
    @ This method provides to encoder block
    @ params : 
        @@ layer_in: input layer
		@@ n_filters: number of filters 
		@@ batchnorm: specify if there is batch norm or not
    @ returns : 
        @@ model: the encoder block 
    """
...
print("GPU: {}, CPU: {}".format(gpu_list,cpu_list))
